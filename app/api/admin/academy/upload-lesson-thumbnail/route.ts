...
/**
 * POST /api/admin/academy/upload-lesson-thumbnail
 * FormData: file (imagem), lessonId
 * Upload para academy-assets/thumbnails/lessons/{lessonId}/{timestamp}.ext
 * Retorna { path } para salvar em academy_lessons.thumbnail_url
 */
export async function POST(req: NextRequest) {
  ...
  const filePath = `thumbnails/lessons/${lessonId}/${Date.now()}.${ext}`;
  try {
    ...
    console.error('[admin/academy/upload-lesson-thumbnail]', e);
