...
export async function GET(
  ...
  try {
    ...
    // Verifica se o gerente pertence à banca
      ...
      consultores
        ...
        .map(async (consultor) => {
          try {
            ...
            console.warn(`[Top5] Erro ao buscar métricas do consultor ${consultor.email}:`, error);
          }
          return null;
        })
    );

    // Filtra nulos, ordena por vendas e pega top 5
