        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-[#E86A24]/15 text-[#6B8E3F] border border-[#E86A24]/30">
            ...
            <div className="space-y-3 min-w-0">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1 text-sm text-[#E86A24] hover:underline"
                >
                ...
                {currentPackage && (
                  <div className="flex flex-wrap items-center gap-2 text-xs">
                    <span className="inline-flex items-center px-2 py-0.5 rounded-md font-semibold bg-[#E86A24]/15 text-[#6B8E3F] border border-[#E86A24]/40">
                          ...
                          <button
                            ...
                            className={`px-2.5 py-1 rounded-md text-[11px] font-semibold transition-colors ${
                              packageLeadStatusTab === 'em_estoque'
                                ? 'bg-[#E86A24]/25 text-[#5a7a35] dark:text-[#E86A24] border border-[#E86A24]/40'
                      ...
                      <div className="flex flex-wrap gap-2 items-center ml-auto">
                        ...
                        {[50, 100, 250, 500].map((n) => (
                          <button
                            ...
                            className="px-2 py-1.5 rounded-lg text-[11px] font-semibold border border-gray-200 dark:border-[#444] bg-gray-50 dark:bg-[#333] hover:bg-[#E86A24]/15 hover:border-[#E86A24]/40 disabled:opacity-40 text-gray-700 dark:text-gray-200"
                          >
                            Primeiros {n}
                          </button>
                        ))}
                        <button
                          ...
                          className="px-2 py-1.5 rounded-lg text-[11px] font-semibold bg-[#E86A24]/15 border border-[#E86A24]/40 text-[#6B8E3F] hover:bg-[#E86A24]/25 disabled:opacity-40"
                        >
                  ...
                  {!isAdminStockViewer && (
                    <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-gray-100 dark:border-[#404040]">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-[#E86A24] text-white hover:bg-[#D95E1B] disabled:opacity-40"
                      >
                        Aplicar ordem atual
                      </button>
                            ...
                            <tr
                              ...
                              className={`border-t border-gray-100 dark:border-[#404040] transition-colors ${
                                isAdminStockViewer
                                  ...
                                  : `cursor-pointer ${checked ? 'bg-[#E86A24]/10 dark:bg-[#E86A24]/15' : 'hover:bg-gray-50 dark:hover:bg-[#333]'}`
                              }`}
                            >
                              {!isAdminStockViewer && (
                ...
                {isAdminStockViewer ? (
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-[#E86A24] text-white font-semibold hover:bg-[#D95E1B] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
              ...
              {currentPackage && (
                <div className="bg-white dark:bg-[#2a2a2a] rounded-xl border border-gray-200 dark:border-[#404040] p-4 text-xs space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1">
                    <LegendDot color="#E86A24" label="Em estoque" value={currentPackage.pending_leads} />
          ...
          <div className="max-w-5xl mx-auto flex items-center gap-3">
            ...
            {packageLeadStatusTab === 'em_estoque' ? (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#E86A24] text-white font-semibold hover:bg-[#D95E1B] disabled:opacity-50"
              >
                {transferring ? <Loader2 className="w-4 h-4 animate-spin" /> : <CheckSquare className="w-4 h-4" />}
                Transferir
              </button>
...
function KpiCard({
  ...
  const toneMap: Record<string, string> = {
    ...
    brand: 'text-[#6B8E3F] bg-[#E86A24]/15 border-[#E86A24]/40',
...
function ProgressBar({
  ...
  return (
    <div className="w-full h-2.5 rounded-full bg-gray-100 dark:bg-[#333] overflow-hidden flex">
      <span className="h-full bg-[#E86A24]" style={{ width: toPct(pending) }} />
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5">
                      <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-semibold bg-[#E86A24]/15 text-[#6B8E3F] border border-[#E86A24]/40">
                        {p.transfer_type}
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <span className="inline-flex items-center justify-center min-w-[40px] px-2 py-0.5 rounded-md text-sm font-bold tabular-nums bg-[#E86A24]/15 text-[#6B8E3F]">
                        {p.pending_leads}
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <div className="inline-flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-1.5">
                        <button
                          ...
                          className="inline-flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold bg-[#E86A24] text-white hover:bg-[#D95E1B] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${
        active
          ? 'border-[#E86A24] text-[#6B8E3F] dark:text-[#E86A24]'
...
function HistoryStatusBadge({ item }: { item: HistoryItem }) {
  ...
  switch (item.status_label) {
    ...
    default:
      return (
        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-semibold bg-[#E86A24]/15 text-[#6B8E3F] border border-[#E86A24]/40">
            ...
            {filters.map((f) => (
              <button
                ...
                className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                  filter === f.id
                    ? 'bg-[#E86A24]/15 text-[#6B8E3F] dark:text-[#E86A24]'
