                      ...
                      <tr key={inst.id} className="hover:bg-gray-50 dark:hover:bg-[#333]">
                        ...
                        <td className="px-4 py-3">
                          {totalSlots === 0 ? (
                            ...
                            >
                              {hasCustom ? (
                                <span className="inline-flex items-center gap-1 bg-[#E86A24]/20 text-[#5a8a2a] dark:text-[#E86A24] border border-[#E86A24]/30 rounded-lg px-2 py-0.5">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <button
                              onClick={() => setSelectedMessages(inst)}
                              className="p-2 rounded-lg text-[#E86A24] hover:bg-[#E86A24]/10 transition"
                              title="Ver mensagens"
                            >
                          ...
                          return (
                            <div
                              ...
                              className={`rounded-lg border overflow-hidden ${
                                hasCustom
                                  ? 'border-[#E86A24]/40 dark:border-[#E86A24]/30'
                            ...
                            >
                              ...
                              <div className={`flex items-center justify-between px-4 py-2 text-xs font-semibold ${
                                hasCustom
                                  ? 'bg-[#E86A24]/10 dark:bg-[#E86A24]/20 text-[#5a8a2a] dark:text-[#E86A24]'
                                  : 'bg-gray-50 dark:bg-[#333] text-gray-500 dark:text-gray-400'
                              }`}>
                                <span>Mensagem {idx + 1}</span>
                                <span className={`px-2 py-0.5 rounded text-xs ${
                                  hasCustom
                                    ? 'bg-[#E86A24]/20 text-[#5a8a2a] dark:text-[#E86A24]'
