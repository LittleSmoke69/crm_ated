...
import type { NewsTopbarProps, NewsMarqueeProps, ArticleMetaProps, HeadlineRichProps } from '@/lib/vsl/runtime/types';
...
export function VslDesignPanel({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 w-full min-h-0 bg-gray-100 rounded-xl p-4 lg:h-[calc(100vh-11rem)]">
      ...
      <div className="lg:col-span-7 flex flex-col min-w-0 min-h-[520px] lg:min-h-0">
        <div className="bg-white rounded-xl border border-gray-200 flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="flex-1 min-h-0 p-4 bg-gray-100/80 overflow-y-auto overflow-x-hidden flex justify-center">
            <div className="mx-auto w-full max-w-[560px] rounded-[2.5rem] border-[12px] border-gray-800 bg-gray-800 shadow-xl overflow-hidden flex-shrink-0">
              <div className="h-6 bg-gray-800 flex justify-center">
                <div className="w-24 h-5 rounded-b-2xl bg-gray-900" />
              </div>
              <div className="bg-white w-full overflow-y-auto overflow-x-hidden min-h-[520px] h-[70vh] max-h-[680px] scroll-smooth">
                {content ? (
