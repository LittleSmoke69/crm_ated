        ...
        <div className="p-4 space-y-4 flex-shrink-0 border-b border-gray-200">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-white border border-gray-300 rounded-xl pl-10 pr-4 py-2.5 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#8CD955] focus:border-[#8CD955] placeholder:text-gray-400"
            />
          </div>
