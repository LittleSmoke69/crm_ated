...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_maturation_steps_status_scheduled
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_evolution_instances_active_ok
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_evolution_instances_virgin_maturation
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_master_instances_evolution_instance
  ON master_instances (evolution_instance_id);

-- chat_conversations: upsert conflict resolution
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_chat_conversations_conflict_key_jid
  ON chat_conversations (conflict_key, remote_jid);

-- chat_messages: upsert conflict resolution
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_chat_messages_conv_msg
  ON chat_messages (conversation_id, message_id);

-- evolution_instance_logs: recent logs per instance
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_evolution_instance_logs_instance_created
