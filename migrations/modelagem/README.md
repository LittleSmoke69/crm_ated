...
| 01 | `01_roles_keep_four.sql` | **Acesso** — manter só 4 cargos | `zaploto_roles.is_active`; desativa auditoria/dono_banca/gestor/gerente; reafirma sidebar de super_admin, admin, suporte, consultor |
...
- **03 Chat:** o inbox de atendimento chama `chat_claim_next_official()` para puxar a próxima
  ...
  com os usuários de cargo **suporte** por número oficial.
