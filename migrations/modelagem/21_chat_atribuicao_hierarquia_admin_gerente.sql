-- Impõe a hierarquia de atribuição de conversas do chat oficial:
-- admin/super_admin só podem atribuir a um GERENTE (nunca direto a um captador);
...
--
-- Idempotente: substitui a função criada em 20_chat_crm_atribuicao.sql.
...
BEGIN
  ...
  -- Gerente atribuindo a um captador do seu time: fluxo completo (chat + CRM + kanban),
  -- igual ao comportamento anterior a esta migration.
