-- =====================================================
-- Fila de campanhas (add-to-group): campaigns, grupos, jobs e RPCs.
-- Referenciado em MIGRATION_EXECUTE.md; necessário para o worker Netlify.
-- Depende: 0000_foundation_supabase_core.sql (profiles).
...
-- Claim atômico (opcional; assinatura alinhada a fix_rls_and_permissions.sql)
