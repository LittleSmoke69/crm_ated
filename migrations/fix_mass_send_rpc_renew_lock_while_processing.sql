-- Mantém lock (locked_at / locked_by) enquanto status = 'processing', para que
-- outro worker não assuma o job entre um grupo e outro. Libera lock apenas ao concluir.
