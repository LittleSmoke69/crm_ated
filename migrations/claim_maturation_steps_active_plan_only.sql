-- Não reivindica steps de jobs cujo plano de maturação está inativo (is_active = false).
-- Evita retries/envios após o usuário desativar o plano; alinhado a lib/services/maturation/processor.ts.
...
COMMENT ON FUNCTION claim_maturation_steps IS
  'Reivindica steps pendentes apenas com plano ativo (is_active), master_instance, evolution_instance e evolution_api válidos.';
